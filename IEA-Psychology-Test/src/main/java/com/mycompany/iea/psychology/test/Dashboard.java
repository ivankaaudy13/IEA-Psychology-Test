...
public class Dashboard extends javax.swing.JFrame {
     ...
     */
    public Dashboard(String USERNAME_) {
        initComponents();
    ...
    private void initComponents() {
        ...
        YES_BTN.setBackground(new java.awt.Color(18, 15, 131));
        ...
        jPanel1.add(YES_BTN, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 490, 190, 60));

        WELCOME_TEXT.setFont(new java.awt.Font("SansSerif", 1, 36)); // NOI18N
        WELCOME_TEXT.setForeground(new java.awt.Color(231, 221, 221));
        WELCOME_TEXT.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        WELCOME_TEXT.setText("USER");
        jPanel1.add(WELCOME_TEXT, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 260, 430, 43));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/iea/psychology/test/iconimage/Dashboard.png"))); // NOI18N
